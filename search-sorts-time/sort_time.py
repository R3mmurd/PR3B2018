...
if __name__ == '__main__':
    ...
    plt.plot(sizes, ss_times, label='selection sort to unsorted list')
    plt.plot(sizes, is_times, label='insertion sort to unsorted list')
    plt.plot(sizes, sss_times, label='selection sort to sorted list')
    plt.plot(sizes, sis_times, label='insertion sort to sorted list')
    plt.show()
